...
<div class="wrapper row1">
  <header id="header" class="hoc clear"> 
    ...
    <div id="logo" class="one_quarter first">
      <h1><a href="home.php"><b>REYES REAL ESTATE SOCIAL NETWORK</b></a></h1>
...
<div class="wrapper row3">
  <main class="hoc container clear"> 
    ...
    <!-- ################################################################################################ -->
    <div class="content"> 
<h1><u>Browse Agents By Years of License Ownership</u></h1>
      ...
      $ID = $ret['UserID'];
			$sql = "Select UserID,FirstName,LastName, YearsLicensed,City,State,Email from users where UserID != $ID ORDER BY YearsLicensed";
